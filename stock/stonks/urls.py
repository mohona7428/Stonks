...
urlpatterns = [
    ...
    path('finalBuy', views.finalBuy, name="finalBuy"),
    path('BuyPage', views.BuyPage),
    path('SellPage', views.SellPage),
    path('buy', views.buy, name="buy"),
    path('sell/<stockname>/', views.sell, name="sell"),
    path('finalSell', views.finalSell, name="finalSell"),
    path('transactions', views.transactions, name="transactions"),
    path('dashboard', views.index, name='index'),
    path('trade', views.trade, name="trade"),
    path('csv_month', views.csv_month, name='csv_month'),
]
